    ...
    <>
      ...
      <div style={styles.container}>
        <div style={styles.content}>
          ...
          <Tilt tiltMaxAngleX={2} tiltMaxAngleY={2} perspective={1000} scale={1.01} transitionSpeed={1500} style={{ marginBottom: "3rem" }}>
            <div style={{ ...styles.section, background: "rgba(255,255,255,0.02)", padding: "2rem", borderRadius: "16px", border: "1px solid rgba(255,255,255,0.03)", marginBottom: 0 }}>
              <h2 style={{ ...styles.sectionTitle, marginTop: 0 }}>Getting Started</h2>
          ...
          <Tilt tiltMaxAngleX={2} tiltMaxAngleY={2} perspective={1000} scale={1.01} transitionSpeed={1500} style={{ marginBottom: "3rem" }}>
            <div style={{ ...styles.section, background: "rgba(255,255,255,0.02)", padding: "2rem", borderRadius: "16px", border: "1px solid rgba(255,255,255,0.03)", marginBottom: 0 }}>
              <h2 style={{ ...styles.sectionTitle, marginTop: 0 }}>Core Features</h2>
              <div style={styles.sectionContent}>
          ...
          <Tilt tiltMaxAngleX={2} tiltMaxAngleY={2} perspective={1000} scale={1.01} transitionSpeed={1500} style={{ marginBottom: "3rem" }}>
            <div style={{ ...styles.section, background: "rgba(255,255,255,0.02)", padding: "2rem", borderRadius: "16px", border: "1px solid rgba(255,255,255,0.03)", marginBottom: 0 }}>
              <h2 style={{ ...styles.sectionTitle, marginTop: 0 }}>Privacy & Security</h2>
              <div style={styles.sectionContent}>
                <p>
          ...
          <Tilt tiltMaxAngleX={2} tiltMaxAngleY={2} perspective={1000} scale={1.01} transitionSpeed={1500} style={{ marginBottom: "3rem" }}>
            <div style={{ ...styles.section, background: "rgba(255,255,255,0.02)", padding: "2rem", borderRadius: "16px", border: "1px solid rgba(255,255,255,0.03)", marginBottom: 0 }}>
              <h2 style={{ ...styles.sectionTitle, marginTop: 0 }}>Quick Commands</h2>
              <div style={styles.sectionContent}>
          ...
          <div style={styles.section}>
            ...
            <div style={styles.sectionContent}>
              ...
              <div style={styles.flowContainer}>
                ...
                <Tilt tiltMaxAngleX={2} tiltMaxAngleY={2} perspective={1000} scale={1.01} transitionSpeed={1500}>
