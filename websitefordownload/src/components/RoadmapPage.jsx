...
import { ArrowLeft, Zap, Rocket, Target, Sparkles } from 'lucide-react';
        ...
        <>
            ...
            <div style={{
                ...
                <div style={{ position: "relative", paddingLeft: "2rem", borderLeft: "2px solid rgba(255,255,255,0.1)" }}>
                    {[
                        { icon: Target, title: "Q1: Beta Launch", desc: "Initial release to early access users with core encryption features.", status: "In Progress" },
                        { icon: Rocket, title: "Q2: Mobile Apps", desc: "Native iOS and Android applications for secure messaging on the go.", status: "In Progress" },
                        { icon: Sparkles, title: "Q3: Enterprise API", desc: "SDKs for businesses to integrate secure messaging into their products.", status: "Planned" }
                    ].map((item, index) => (
                        <Tilt key={index} tiltMaxAngleX={3} tiltMaxAngleY={3} perspective={1000} scale={1.01} transitionSpeed={1500} style={{ marginBottom: "3rem" }}>
